...
class dlgPreferences(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        wx.Dialog.__init__(
            self, parent, -1, "Preferences", style=wx.DEFAULT_DIALOG_STYLE
        )
        self.parent = parent
    ...
    def makeUpdatesPage(self):
        ...
        label_label = wx.StaticText(
            panel,
            -1,
            "mMass can use your internet connection to automatically\ncheck for newer versions and updates.",
        )

        self.updatesEnabled_check = wx.CheckBox(
            panel, -1, "Automatically check for updates"
        )
    ...
    def makeCompassPanel(self):
        ...
        self.compassFormat_choice = wx.Choice(
            panel,
            -1,
            choices=["mzXML", "mzData", "mzML"],
            size=(120, mwx.CHOICE_HEIGHT),
        )
        ...
        grid.Add(
            compassMode_label, (0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.compassMode_choice, (0, 1))
        grid.Add(
            compassFormat_label, (1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.compassFormat_choice, (1, 1))
        grid.Add(
            compassDeleteFile_label,
            (2, 0),
